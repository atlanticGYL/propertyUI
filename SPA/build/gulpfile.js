...
var requirejsOptimize = require('./gulp-requirejs-optimize.js')

gulp.task('js-build', () => {
  var config = require('../src/config.js')
  gulp.src(['../src/**/*.js', '!../src/assets/**', '!../src/icons/**'])
    .pipe(requirejsOptimize({
      ...
      ...{
        ...
        // extends: [...config.exclude],
        excludeShallow: [...config.exclude],
      }
    })).pipe(gulp.dest('../dist'));
